...
<!-- <link rel="canonical" href="<?php //echo $this->canonicalUrl?>">-->
  ...
  <link rel="stylesheet" media="all" href="/css/blog/screen.css" >
  <link rel="stylesheet" media="all" href="/css/blog/main.css" >
...
if($controllerId=="site" || $controllerId=="goal" || $controllerId=="avatar" || $controllerId == "blogposts"){
                    ...
                    <div class="mainMenu-box">
                        ...
                        <div class="section-wrapper clearfix">
                            ...
                            <ul class="mainMenu clear-ul">
                                ...
                                <li><a href="<?php echo Yii::app()->createUrl("blog"); ?>" class="mainMenu-item item5 "><?php echo Yum::t("БЛОГ")?></a></li>
...
//                                )); 
   ...
   <script src="/js/blog/lib/head.js" data-headjs-load="/js/blog/init.js"></script> 
</body>
</html>
