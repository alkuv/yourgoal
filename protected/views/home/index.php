...
?>
                                ...
                                <a href="<?php echo  Yii::app()->createAbsoluteUrl("/goal/view/id/$goal->id") ?>" class="img-box">
									...
									<img src="<?php echo  Yii::app()->baseUrl?>/images/nogoal.jpg" width="471" height="264" alt="<?php echo $goal->name ?>" />
									<?php } else {?>
                                    <img src="<?php echo Yii::app()->baseUrl."/".$goal->image;?>" width="471" height="264" alt="<?php echo $goal->name ?>"/>
									<?php } ?>
            ...
            ?>
								...
								<?php if($more==1) {?>
							<a class="readmore" style="z-index:2147483647;"href="<?php echo  Yii::app()->createAbsoluteUrl("/goal/view/id/$goal->id") ?>"></a><?php } ?>
                            </div>
						<?php  } $k++;} ?>
...
<?php } ?>
                ...
                <section class="joinUs">
                    ...
                    <div class="section-wrapper clearfix">                       
                        ...
                        <p>Сегодня нам 20 лет, а завтра уже 30 и 45!<br>
