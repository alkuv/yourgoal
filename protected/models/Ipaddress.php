...
class Ipaddress extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, goal_id, ip_address', 'required'),
			array('user_id, goal_id', 'numerical', 'integerOnly'=>true),
			array('ip_address', 'length', 'max'=>111),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, goal_id, ip_address', 'safe', 'on'=>'search'),
		);
	}
