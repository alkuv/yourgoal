<?php 
####ADDED BY SHIV FOR THEME SUPPORT IN YUM TO OUR THEME
Yii::setPathOfAlias('YumThemes' , dirname(Yii::app()->request->scriptFile).'/themes/yours-goal/');
...
class UserModule extends CWebModule {
	...
	public $baseLayout = 'YumThemes.views.layouts.main';####MODIFIED BY SHIV FOR THEME SUPPORT IN YUM TO OUR THEME
...
####ADDED BY SHIV FOR THEME SUPPORT IN YUM TO OUR THEME
        public $loginLayout = 'YumThemes.views.layouts.main';
        public $adminLayout = 'YumThemes.views.layouts.main';
