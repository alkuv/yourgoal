...
<div class="wra">
    ...
    <div class="header">
        <?php //echo "herer";?>
    	<div class="w1000">
        	<div class="logo"><a href="<?php echo Yii::app()->getBaseUrl()."/index.php/admin/site/index"; ?>"><img src="<?php echo Yii::app()->baseUrl; ?>/images/backend/logo.png" alt="" /></a></div>
            <div class="name">
           	 <img src="<?php echo Yii::app()->baseUrl; ?>/images/backend/admin_name.png" width="467" height="82" alt="" /><br />
                 ...
                 <a href="<?php echo Yii::app()->getBaseUrl()."/index.php/admin/site/setting"; ?>"><img src="<?php echo Yii::app()->baseUrl; ?>/images/backend/icon/setting.png" alt="" width="18" height="15" border="0" /> <strong>Setting</strong></a>
                 <a href="<?php echo Yii::app()->getBaseUrl()."/index.php/admin/site/logout"; ?>"><img src="<?php echo Yii::app()->baseUrl; ?>/images/backend/icon/sign_out.png" width="15" height="15" alt="" /> <strong>Logout</strong></a>
            </div>
            <div class="clear"></div>
        </div>
    </div>
