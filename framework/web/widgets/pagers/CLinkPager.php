...
class CLinkPager extends CBasePager
{
	...
	protected function createPageButton($label,$page,$class,$hidden,$selected)
	{
		...
		if(Yii::app()->controller)
			return '<li class="'.$class.'">'.CHtml::link($label,$this->createPagUrl($this->getController(),$page)).'</li>';
		else	
			return '<li class="'.$class.'">'.CHtml::link($label,$this->createPageUrl($this->getController(),$page)).'</li>';
	}

	public function createPagUrl($controller,$page)
	{
